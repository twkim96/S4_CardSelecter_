...
function Home(){
    return(
        <div className={"homepage"}>
            ...
            <ShowBar/>
            <GoBoard/>
            <CardMain name='20대에게 인기가 많은 카드' orderBy={0} choice={"score20"} itemCount={4} color={"#ffffff"}/>
            <CardMain name='대중교통러들에게 추천하는 카드' orderBy={1} choice={"교통카드 할인"} itemCount={3} color={"#f5f5f5"}/>
            <GoChart/>
            <CardMain name='학생을 키우는 부모님에게 추천하는 카드' orderBy={1} choice={"교육비 할인"} itemCount={4} color={"#f5f5f5"}/>
